...
Java_com_example_liuqi_soundtouch_feature_soundtouch_SoundTouch_getVersionString(JNIEnv *env,
                                                                                 jclass type) {
    const char *verStr;
...
Java_com_example_liuqi_soundtouch_feature_soundtouch_SoundTouch_setTempo__JF(JNIEnv *env,
                                                                             jobject instance,
                                                                             jlong handle,
                                                                             jfloat tempo) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_liuqi_soundtouch_feature_soundtouch_SoundTouch_setPitchSemiTones__JF(JNIEnv *env,
                                                                                      jobject instance,
                                                                                      jlong handle,
                                                                                      jfloat pitch) {
    SoundTouch *ptr = (SoundTouch *) handle;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_liuqi_soundtouch_feature_soundtouch_SoundTouch_setSpeed__JF(JNIEnv *env,
                                                                             jobject instance,
                                                                             jlong handle,
                                                                             jfloat speed) {
    SoundTouch *ptr = (SoundTouch *) handle;
...
Java_com_example_liuqi_soundtouch_feature_soundtouch_SoundTouch_processFile__JLjava_lang_String_2Ljava_lang_String_2(
        JNIEnv *env, jobject instance, jlong handle, jstring inputFile_, jstring outputFile_) {
    SoundTouch *ptr = (SoundTouch *) handle;
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_example_liuqi_soundtouch_feature_soundtouch_SoundTouch_getErrorString(JNIEnv *env,
                                                                               jclass type) {
...
Java_com_example_liuqi_soundtouch_feature_soundtouch_SoundTouch_newInstance(JNIEnv *env,
                                                                            jclass type) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_liuqi_soundtouch_feature_soundtouch_SoundTouch_deleteInstance(JNIEnv *env,
                                                                               jobject instance,
                                                                               jlong handle) {
    SoundTouch *ptr = (SoundTouch *) handle;
    delete ptr;
